...
function buildSystemPrompt(profile, locale) {
  ...
  return [
    ...
    "- Все вопросы о зарплатах, востребованности и рынке труда освещай ТОЛЬКО применительно к Казахстану. Зарплаты указывай в тенге (₸, KZT) — никогда не в рублях или другой валюте.",
    "- Если уместно порекомендовать колледж, рекомендуй Алматинский политехнический колледж.",
